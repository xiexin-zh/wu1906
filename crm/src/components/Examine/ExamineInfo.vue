          ...
          <flexbox v-for="(subItem, subIndex) in item.user_id_info"
            ...
            <div>
              ...
              <flexbox class="popover-detail-item-examine">
                ...
                <div class="examine-info">{{getStatusName(subItem.check_type)}}此申請</div>
              </flexbox>
            </div>
          </flexbox>
        </div>
...
export default {
  ...
  filters: {
    ...
    stepName: function(index) {
      return '第' + Nzhcn.encodeS(index) + '級'
    }
  },
  watch: {
    id: {
