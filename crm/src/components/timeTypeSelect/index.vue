<template>
  ...
  >
    <div class="type-popper">
      ...
      <div class="type-content-custom" v-if="showCustomContent">
        <el-date-picker
          v-model="startTime"
          type="date"
        ...
        <el-button @click="customSureClick">確定</el-button>
      </div>
    </div>
    <el-input
      slot="reference"
      ...
      class="type-select"
    >
      <i slot="suffix" :class="['el-input__icon', 'el-icon-' + iconClass]"></i>
    </el-input>
  </el-popover>
</template>
