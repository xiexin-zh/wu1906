    ...
    <div v-if="popoverContentShow">
      ...
      <div class="popover-content-box">
        <div class="select-input">
          ...
          <el-tabs v-model="activeTabName"
                   :stretch="true"
                   @tab-click="tabClick">
            <el-tab-pane label="員工"
                         name="user"
                         v-if="!closeUser"
                         v-loading="userLoading">
              <el-input placeholder="搜索員工"
                        size="mini"
        ...
        <div class="checked-content">
          <div class="checked-top">
            <span class="title">已選擇員工({{userSelectCount }}) 部門 ({{depSelectCount}})</span>
            <el-button type="text"
                       class="rt"
      ...
      <div class="popover-footer">
        <el-button type="primary"
                   @click="popoverSubmit">確 定</el-button>
