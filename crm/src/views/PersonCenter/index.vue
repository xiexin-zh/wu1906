  ...
  <div v-loading="loading"
    ...
    <div class="header-handle">
      <el-button type="primary"
                 @click="editClick('password')">修改密碼</el-button>
      <el-button type="primary"
                 @click="editClick('info')">編輯</el-button>
      <el-button plain
    ...
    <flexbox class="person-info">
      ...
      <div class="person-body">
        ...
        <div class="person-detail">部門：{{userInfo.structure_name}}&nbsp;&nbsp;&nbsp;&nbsp;職位：{{userInfo.post}}</div>
      </div>
    </flexbox>
  ...
  data() {
    return {
      ...
      list: [
        ...
        { name: '性別', props: 'sex' },
        { name: '手機號（登錄名）', props: 'username' },
        { name: '郵箱', props: 'email' },
        { name: '部門', props: 'structure_name' },
        { name: '崗位', props: 'post' },
        { name: '直屬上級', props: 'parent_name' }
      ]
    }
  },
  mounted() {
