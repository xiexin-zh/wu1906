...
export default {
  ...
  data() {
    return {
      ...
      axisList: [],
      fieldList: [
        { field: 'business_name', name: '商機名稱' },
        { field: 'customer_name', name: '戶口名稱' },
        { field: 'type_id_info', name: '商機狀態組' },
        { field: 'status_id_info', name: '商機階段' },
        { field: 'money', name: '商機金額' },
        { field: 'deal_date', name: '預計成交日期' },
        { field: 'owner_user_name', name: '跟進人' },
