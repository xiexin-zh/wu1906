...
export default {
  ...
  data() {
    return {
      ...
      headFieldList: [
        { field: 'category_id_info', name: '產品分類', width: '115px' },
        { field: 'product_id', name: '產品名稱', width: '115px' },
        { field: 'contract_id', name: '合同編號', width: '115px' },
        { field: 'owner_user_id', name: '跟進人', width: '115px' },
        { field: 'customer_id', name: '戶口名稱', width: '115px' },
        { field: 'sales_price', name: '銷售單價', width: '115px' },
        { field: 'num', name: '數量', width: '115px' },
        { field: 'subtotal', name: '訂單產品小計', width: '115px' }
      ],
      infoFieldList: [
        { field: 'name1', name: '產品分類', width: '115px' },
        { field: 'name2', name: '產品名稱', width: '115px' },
        { field: 'name3', name: '合同編號', width: '115px' },
        { field: 'name4', name: '跟進人', width: '115px' },
        { field: 'count', name: '戶口名稱', width: '115px' },
        { field: 'money', name: '銷售單價', width: '115px' }
      ],
      list: [],
      //
      spanList: [],
