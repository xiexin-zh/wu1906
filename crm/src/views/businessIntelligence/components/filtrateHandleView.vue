<template>
  <div class="filtrate-content">
    ...
    <el-button @click.native="postFiltrateValue()" type="primary"
      >搜索</el-button
    >
  </div>
</template>
...
import {
  staticDeptList,
  staticUserOptions
} from "../../../assets/data/deptList/dept-list";
  ...
  methods: {
    ...
    getUserList() {
      ...
      getSubUserByStructrue(params)
        .then(res => {
          this.userOptions = staticUserOptions;
          this.userSelectValue = this.userOptions[0].realname;
          // if (window.document.location.hash == "#/crm/salesman") {
          //   this.userOptions = [{ id: 1, realname: "管理员" }];
          //   this.userSelectValue = this.userOptions[0].realname;
          // } else {
