<template>
  <div v-loading="loading"
    ...
    <filtrate-handle-view class="filtrate-bar"
                          ...
                          :customOptions="[{name:'折線圖', value: 'line'}, {name:'餅狀圖', value: 'pie'},{name:'柱狀圖', value: 'bar'}]"
                          @load="loading=true"
                          @change="searchClick"
...
export default {
  ...
  data() {
    return {
      ...
      axisList: [],
      fieldList: [
        { field: 'name', name: '戶口名稱' },
        { field: 'face_id', name: '用戶ID' },
        { field: 'contract_name', name: '合同名稱' },
        { field: 'contract_money', name: '合同金額（元）' },
        { field: 'r_money', name: '回款金額（元）' },
        { field: 'industry', name: '戶口類型' },
        { field: 'source', name: '戶口來源' },
        { field: 'owner_realname', name: '跟進人' },
        { field: 'create_realname', name: '創建人' },
        { field: 'create_time', name: '創建時間' },
        { field: 'order_time', name: '下單時間' }
      ]
    }
  },
  mixins: [base],
