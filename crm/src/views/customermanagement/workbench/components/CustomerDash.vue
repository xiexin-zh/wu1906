    ...
    <flexbox :gutter="0" wrap="wrap">
          ...
          <flexbox :gutter="0" wrap="wrap">
            ...
            >
              <flexbox class="jianbao-icon-content">
                <img class="jianbao-icon" :src="item.icon" />
      ...
      >
        <div class="card" style="height: 350px;">
          ...
          <div class="gauge" id="gaugemain"></div>
          <flexbox justify="center" class="target-items">
            <div class="target-item">
              <div class="name">目標</div>
              <div class="value">{{ gaugeData.achievementMoney }}元</div>
            </div>
            <div class="target-item">
              <div class="name">合同金額</div>
              <div class="value">{{ gaugeData.contractMoney }}元</div>
            </div>
            <div class="target-item">
              <div class="name">回款金額</div>
      ...
      >
        <div class="card" style="height: 400px;">
          <flexbox class="mark-header"
            ><img class="img-mark" src="@/assets/img/loudou.png" />銷售漏斗
          </flexbox>
          ...
          <div id="funnelmain" class="funnel"></div>
          <div class="funnel-label">
            <div>贏單：{{ funnelData.sum_ying }}元</div>
            <div>輸單：{{ funnelData.sum_shu }}元</div>
          </div>
        </div>
      </flexbox-item>
      <flexbox-item
        ...
        <div class="card" style="height: 400px;">
          ...
          <div class="trend-label">
            <flexbox class="label-item">
              ...
              ></div>
              <div class="label-item-name">合同金額</div>
            </flexbox>
            <flexbox class="label-item" style="margin-top:5px;">
              <div
                class="label-item-mark"
                style="background-color: #ff7474"
              ></div>
              <div class="label-item-name">回款金額</div>
            </flexbox>
          </div>
