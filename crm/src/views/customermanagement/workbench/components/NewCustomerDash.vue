      ...
      >
        <div class="card">
          <flexbox class="mark-header">
            <img class="img-mark" src="@/assets/img/jianbao.png" />綜合簡報
          </flexbox>
          <flexbox :gutter="0" wrap="wrap">
            <flexbox-item
              :span="1 / 2"
  ...
  data() {
    return {
      ...
      jianbaoItems: [
        ...
        {
          title: "新增投訴",
          icon: require("@/assets/img/c_complaints.png"),
          field: "recordNum",
          value: 0
        },
        {
          title: "新增需求",
          icon: require("@/assets/img/c_demand.png"),
          field: "recordNum",
          value: 0
        },
        {
          title: "新增意見",
          icon: require("@/assets/img/c_opinion.png"),
          field: "recordNum",
          value: 0
        },
        {
          title: "新增禮遇",
          icon: require("@/assets/img/c_courtesy.png"),
          field: "recordNum",
          value: 0
        },
        {
          title: "新增入場動態",
          icon: require("@/assets/img/c_entrance.png"),
          field: "recordNum",
          value: 0
        },
        {
          title: "新增過往博彩經驗",
          icon: require("@/assets/img/c_past.png"),
          field: "recordNum",
          value: 0
        },
        {
          title: "新增購物紀錄",
          icon: require("@/assets/img/c_shopping.png"),
          field: "recordNum",
          value: 0
        }
        // {
