  ...
  <div class="header_crm">
    ...
    >
      ...
      >
        ...
        <!-- <el-table-column prop="communication" label="狀態asdasd">
          <template slot-scope="scopeBtn">
            <el-button
              type="info"
              v-show="scopeBtn.row.communication === '未開始'"
              >未開始</el-button
            >
            <el-button
              type="warning"
              v-show="scopeBtn.row.communication === '失敗'"
              >失敗</el-button
            >
            <el-button
              type="primary"
              v-show="scopeBtn.row.communication === '進行中'"
              >進行中</el-button
            >
            <el-button
              type="success"
              v-show="scopeBtn.row.communication === '已完結'"
              >已完結</el-button
            >
          </template>
        </el-table-column>-->
...
.el-table /deep/ tbody tr td .cell {
  text-align: center;
}
.el-button {
  width: 65px;
