      ...
      <el-table-column label="操作"
        ...
        <template slot-scope="scope">
          <flexbox justify="center">
            <el-button type="text"
                       @click.native="handleFile('preview', scope)">預覽</el-button>
            <el-button type="text"
                       @click.native="handleFile('edit', scope)">重命名</el-button>
            <el-button type="text"
                       @click.native="handleFile('delete', scope)">刪除</el-button>
          </flexbox>
        </template>
      </el-table-column>
    </el-table>
    <el-dialog title="編輯"
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="confirmEdit">確 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  mounted() {
    this.fieldList.push({ prop: 'name', width: '200', label: '附件名稱' })
