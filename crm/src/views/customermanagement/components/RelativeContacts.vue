...
export default {
  ...
  methods: {
    ...
    getFieldList() {
      ...
      this.fieldList.push({ prop: 'mobile', width: '200', label: '手機' })
      this.fieldList.push({ prop: 'post', width: '200', label: '職務' })
    },
