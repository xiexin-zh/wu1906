...
export default {
  ...
  methods: {
    getFieldList() {
      this.fieldList.push({ prop: 'num', width: '200', label: '合同編號' })
      this.fieldList.push({ prop: 'name', width: '200', label: '合同名稱' })
      this.fieldList.push({
        prop: 'customer_id',
        width: '200',
        label: '戶口名稱'
      })
      this.fieldList.push({ prop: 'money', width: '200', label: '合同金額' })
      this.fieldList.push({
        prop: 'start_time',
        width: '200',
        label: '開始日期'
      ...
      this.fieldList.push({ prop: 'end_time', width: '200', label: '結束日期' })
