<template>
  <el-dialog title="场景管理"
             ...
             :append-to-body="true"
             width="700px">
    <div class="scene-name">您可通過拖拽管理標籤</div>
    <flexbox class="scene-list">
      <div class="scene-list-box">
        <flexbox class="scene-list-head">
          ...
          <div class="scene-list-head-name">顯示的標籤</div>
            ...
            <div class="list-item-handle">
              <el-dropdown @command="defaultHandle"
                ...
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item>設置為默認標籤</el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </div>
          </flexbox>
      ...
      <div class="scene-list-box">
        <flexbox class="scene-list-head">
          ...
          <div class="scene-list-head-name">隱藏的標籤</div>
    ...
    <div class="handle-bar">
      <div class="handle-bar-add"
           @click="addAndEditScene('add',{})">+ 新建場景</div>
