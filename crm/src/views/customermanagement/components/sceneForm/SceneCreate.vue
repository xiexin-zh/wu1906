<template>
  <el-dialog :title="edit_id ? '編輯場景' : '新建場景'"
             :visible.sync="visible"
             @close="handleCancel"
             :append-to-body="true"
             width="800px">
    <div class="scene-name-container">
      <div class="scene-name">場景名稱</div>
    ...
    <el-button type="text"
               @click="handleAdd">+ 添加篩選條件</el-button>
    <div class="save">
    ...
    <div slot="footer"
      ...
      <el-button type="primary"
                 @click="handleConfirm">確 定</el-button>
    </div>
  </el-dialog>
</template>
  ...
  methods: {
    ...
    handleConfirm() {
      ...
      for (let i = 0; i < this.form.length; i++) {
        let o = this.form[i]
        if (!o.field || o.field === '') {
          this.$message.error('要篩選的字段名稱不能為空！')
          return
        }
