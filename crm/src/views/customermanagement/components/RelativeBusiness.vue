<template>
  ...
  >
    ...
    <div
      ...
      style="border-top:1px solid #E6E6E6;padding:10px 10px;border-right:1px solid #E6E6E6;border-left:1px solid #E6E6E6;"
    >
      本月入場資訊
    </div>
    <el-table
    ...
    <div
      class="footer "
      style="padding:10px 10px;border-right:1px solid #E6E6E6;border-left:1px solid #E6E6E6;"
    >
      <p>本月</p>
      <p>6次</p>
      <p>全年 | 開戶</p>
    ...
    <div class="footer" style="padding:10px 10px;border:1px solid #E6E6E6;">
      <p>平均逗留天數</p>
      <p>1 天</p>
      <p>平均入場金額</p>
      <p>40.06</p>
...
import { tableContentList } from "../../../assets/data/relativeBusiness/teble-content-list";
export default {
  ...
  methods: {
    ...
    getFieldList() {
      ...
      this.fieldList.push({ prop: "name", width: "200", label: "商機名稱" });
      this.fieldList.push({
        prop: "money",
        width: "200",
        label: "商機金額"
