...
// import { relativeJourneyList } from "../../../assets/data/relativeTableListNum/relative-table-list-num-data";
export default {
  name: "RelativeJourney", //相关联系人商机  可能再很多地方展示 放到客户管理目录下（新建时仅和客户进行关联）
  components: {
