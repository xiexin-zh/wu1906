    ...
    <div class="fl-b">
      ...
      <div class="fl-b-des">
        <flexbox class="fl-b-des-item">
          <div class="fl-b-des-item-name">參與人：</div>
        ...
        <flexbox class="fl-b-des-item">
          <div class="fl-b-des-item-name">開始時間：</div>
          <div>{{data.start_time | moment("YYYY-MM-DD HH:mm:ss")}}</div>
        </flexbox>
        <flexbox class="fl-b-des-item">
          <div class="fl-b-des-item-name">結束時間：</div>
          <div>{{data.end_time | moment("YYYY-MM-DD HH:mm:ss")}}</div>
        </flexbox>
        <flexbox class="fl-b-des-item">
          <div class="fl-b-des-item-name">備註：</div>
          <div>{{data.remark}}</div>
        </flexbox>
      </div>
      <!-- 关联业务 -->
