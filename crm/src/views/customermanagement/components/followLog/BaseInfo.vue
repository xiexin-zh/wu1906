  ...
  <div class="b-cont">
    <div>
      <sections
        ...
        content-height="auto"
      >
        <flexbox :gutter="0" wrap="wrap" style="padding: 10px 8px 0;">
          <flexbox-item
          ...
          >
            ...
            >
              ...
              <!--style="color: #005DF7;cursor: pointer;">{{item.value.location}}</div>-->
              <!--</flexbox>-->
              <!--</flexbox-item>-->
              <flexbox-item :span="0.5" class="b-cell">
                <flexbox class="b-cell-b" align="stretch">
                  <div class="b-cell-name">區域</div>
                  <div class="b-cell-value">
                    {{ item.value.address | addressShow }}
                  </div>
                </flexbox>
              </flexbox-item>
              <flexbox-item :span="0.5" class="b-cell">
                <flexbox class="b-cell-b" align="stretch">
                  <div class="b-cell-name">詳細地址</div>
                  <div class="b-cell-value">
                    {{ item.value.detail_address }}
                  </div>
                </flexbox>
              </flexbox-item>
            </flexbox>
            ...
            >
              ...
              <div class="b-cell-value">
                <flexbox
                  ...
                  :key="index"
                >
                  <img class="f-img" src="@/assets/img/relevance_file.png" />
                  <div class="f-name">
                    {{
                      file.name.length > 15
                  ...
                  <el-button
                    type="text"
                    @click.native="handleFile('preview', item, index)"
                    >預覽</el-button
                  >
                  <el-button
                    type="text"
                    @click.native="handleFile('download', file, index)"
                    >下載</el-button
                  >
                </flexbox>
              </div>
      ...
      filedGetField({
        ...
        .then(res => {
          if (window.document.location.hash === "#/crm/customerInformation") {
            let datalist = [
              {
                ...
                form_type: "create_user_id",
                name: "最近交易",
                value: "2019-10-01 15:36 取款"
              },
              {
                field: "create_user_id",
                form_type: "create_user_id",
            ...
            this.list = datalist.map(function(item, index) {
              return this.handleShowInfo(item);
            });
          } else {
