  ...
  <el-dialog title="批量轉移"
    ...
    <div class="handle-box">
      <flexbox class="handle-item">
        <div class="handle-item-name">變更跟進人為：</div>
      ...
      <flexbox class="handle-item"
               v-if="showRemoveType">
        <div class="handle-item-name">將原跟進人：</div>
        <el-radio-group v-model="removeType">
          <el-radio :label="1">移出</el-radio>
          <el-radio :label="2">轉為團隊成員</el-radio>
        </el-radio-group>
      </flexbox>
      ...
      <flexbox class="handle-item"
        ...
        <div class="handle-item-name">同時變更跟進人至：</div>
        <el-checkbox-group v-model="addsTypes">
          <el-checkbox label="crm_contacts">自然人</el-checkbox>
