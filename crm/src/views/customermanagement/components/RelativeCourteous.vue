...
// import { relativeCourteousList } from "../../../assets/data/relativeTableListNum/relative-table-list-num-data";
export default {
  name: "RelativeCourteous", //相关联系人商机  可能再很多地方展示 放到客户管理目录下（新建时仅和客户进行关联）
  components: {
  ...
  methods: {
    ...
    getFieldList() {
      ...
      this.fieldList.push({ prop: "start_time", width: "200", label: "時間" });
      this.fieldList.push({
        prop: "travel_type",
        width: "200",
        label: "類型"
      ...
      this.fieldList.push({ prop: "address", width: "200", label: "地點" });
      this.fieldList.push({
        prop: "remark",
        width: "200",
        label: "簡述"
