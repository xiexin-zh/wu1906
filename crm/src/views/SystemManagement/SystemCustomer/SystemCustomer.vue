  ...
  <div class="system-customer">
      ...
      <div v-else-if="menuIndex == '3'"
        ...
        <div class="content-title">
          ...
          <el-button type="primary"
                     class="rt"
                     size="medium"
                     @click="addBusiness">添加商機組</el-button>
        </div>
    ...
    <el-dialog title="提示"
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="handleProduct">確 定</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  data() {
    return {
      ...
      businessData: [],
      businessList: [
        { label: '商機組名稱', field: 'name' },
        { label: '應用部門', field: 'structure_id' },
        { label: '創建時間', field: 'create_time' },
        { label: '創建人', field: 'create_user_id' }
      ],
      // 添加商机组
  ...
  methods: {
    ...
    getChild(node) {
      var temps = [
        { type: 'create-child', name: '新建子分類' },
        { type: 'create-brother', name: '新建平級分類' },
        { type: 'edit', name: '編輯分類' },
        { type: 'delete', name: '刪除分類' }
      ]
