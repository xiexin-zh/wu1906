...
export default {
  ...
  data() {
    return {
      menuList: [
        { label: '跟進紀錄類型設置', key: 'follow-log-type-set' },
        { label: '商機組設置', key: 'business-group-set' },
        { label: '產品類別設置', key: 'product-category-set' },
        { label: '合同到期提醒設置', key: 'contract-expire-set' }
      ],
