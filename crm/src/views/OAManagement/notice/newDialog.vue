...
export default {
  ...
  data() {
    return {
      formList: [
        { label: '公告標題', field: 'title' },
        { label: '通知部門', field: 'dep', type: 'plus' },
        { label: '開始時間', field: 'start_time', type: 'date' },
        { label: '結束時間', field: 'end_time', type: 'date' },
      ...
      rules: {
        title: [
          ...
          { max: 50, message: '公告標題長度最多為50個字符', trigger: 'blur' }
        ],
        content: [
          { required: true, message: '公告正文不能為空', trigger: 'blur' }
        ]
      },
      loading: false
    }
