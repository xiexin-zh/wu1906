            ...
            <flexbox v-else-if="item.form_type === 'file'"
              ...
              <div class="b-cell-value">
                <flexbox class="f-item"
                  ...
                  <el-button type="text"
                             @click.native="handleFile('preview', item.value, index)">預覽</el-button>
                  <el-button type="text"
                             @click.native="handleFile('download', file, index)">下載</el-button>
                </flexbox>
              </div>
            </flexbox>
  ...
  data() {
    return {
      ...
      travelField: [
        ...
        { prop: 'trip', label: '單程往返' },
        { prop: 'start_address', label: '出發城市' },
        { prop: 'end_address', label: '目的城市' },
        { prop: 'start_time', label: '開始時間' },
        { prop: 'end_time', label: '結束時間' },
        { prop: 'duration', label: '時長（天）' },
        { prop: 'description', label: '備註' }
      ],
      expensesField: [
        { prop: 'start_address', label: '出發城市' },
        { prop: 'end_address', label: '目的城市' },
        { prop: 'start_time', label: '開始時間' },
        { prop: 'end_time', label: '結束時間' },
        { prop: 'traffic', label: '交通費（元）' },
        { prop: 'stay', label: '住宿費（元）' },
        { prop: 'diet', label: '餐飲費（元）' },
        { prop: 'other', label: '其他費用（元）' },
        { prop: 'description', label: '費用明細描述' }
      ],
