  ...
  <transition name="slide-fade">
    <el-card v-loading="loading"
            ...
            <div class="card-content-row margin-bottom-15">
              ...
              <div class="card-row-right">
                <flexbox class="text-right">
                  <div class="color-label user-name-label"> 跟進人： </div>
            ...
            <div class="add-description">
              <div v-show="!addDescriptionShow">
                ...
                <div v-else
                  ...
                  <span class="color-label">暫無描述</span>
                  <el-button type="text"
                             icon="el-icon-plus"
          ...
          <div class="footer-title">
            <span @click="footerTitle(0)">
              ...
              <span class="cursor-pointer"
                    :style="{'color': isComment ? '#3E84E9' : '#666'}">評論</span>
            </span>
            ...
            <span @click="footerTitle(1)">
              ...
              <span class="cursor-pointer"
                    ...
                    @click="footerTitle(isComment)">活動</span>
            </span>
          </div>
                ...
                <div class="comments-con">
                  <div class="comments-box"
                    ...
                    <div class="btn-group">
                      ...
                      <el-button type="primary"
                                 class="rt"
                                 @click="commentsSub">發布</el-button>
                    </div>
                  </div>
                  <div class="footer-bg"
                       v-else
                       @click="addComments = true">添加評論</div>
                  ...
                  <div class="discuss"
                    ...
                    <div class="discuss-list"
                      ...
                      <div class="rt">
                        <span @click="discussDelete(discussItem, taskData.replyList, k)">刪除</span>
                        <span @click="discussBtn(discussItem, -1)">回復</span>
                      </div>
                      ...
                      <div class="children-reply"
                        ...
                        <div class="discuss-list"
                          ...
                          <div class="rt">
                            <span @click="discussDelete(childDiscussItem, discussItem.replyList, k)">刪除</span>
                            <span @click="discussBtn(discussItem, k)">回復</span>
                          </div>
                          <p class="reply-title">
                            <template>
                              <span>回復</span>
                        ...
                        <div class="btn-group">
                          ...
                          <div class="btn-box">
                            <el-button type="primary"
                                       ...
                                       :loading="contentLoading">回復</el-button>
      ...
      <div class="tip"
        ...
        <span>{{taskData.create_user_info.realname}} 創建於 {{taskData.create_time | moment("YYYY-MM-DD HH:mm:ss")}}</span>
      </div>
...
export default {
  ...
  methods: {
    ...
    // 更多 ———— 删除和规定按钮
    moreDelete() {
      this.$confirm('此操作將永久刪除該任務, 是否繼續?', '提示', {
        ...
        .then(() => {
          deleteTask({
            ...
            .then(res => {
              ...
              this.$message.success('子任務刪除成功')
            })
            .catch(err => {
              this.$message.error('子任務刪除失敗')
            })
        })
        .catch(() => {
          this.$message({
