...
export default {
  ...
  methods: {
    ...
    back() {
      ...
      } else if (this.newTagTitle == '編輯標籤' && this.tagContent == 3) {
        this.tagContent = 2
