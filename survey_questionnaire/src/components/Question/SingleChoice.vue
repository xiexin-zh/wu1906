<template>
  <div class="singleBox">
    ...
    <el-form-item label>
      <div v-for="(option, opIndex) in topic.options" :key="opIndex" class="option-item">
        <el-row :gutter="22">
          <el-col :span="16">
            <el-form-item
              :label="`选项 ${ opIndex + 1 }`"
          ...
          <el-col :span="8">
            <el-button type="success" icon="el-icon-plus" size="mini" @click="addOption(index)" />
            <el-button
              type="warning"
              icon="el-icon-minus"
              size="mini"
        ...
        <!-- <el-row style="margin-bottom: 5px">
          <el-col :span="16">
            <el-form-item label="图片">
              <el-input v-model="option.image" placeholder="请输入图片地址" />
            </el-form-item>
          </el-col>
        </el-row>-->
      </div>
    ...
    >
      <div class="option-addtion">
        <el-switch v-model="topic.isRequired" active-text="有" inactive-text="否" />
        <!-- <div class="tip">
          <div class="tip1">
            <span>在此题后插入新题</span>
          </div>
