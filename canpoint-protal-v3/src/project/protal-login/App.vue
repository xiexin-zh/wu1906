<template>
  <div class="protal-login" :style="{ ...styles }">
    ...
    <div class="dialog-show">
      <div class="dialog-info" v-if="false">
        <div class="font1">
          <span>铸/造/平/安/校/园</span>
          <span style="padding-left: 20px">创/新/智/慧/教/育</span>
        </div>
  ...
  methods: {
    ...
    getYzm() {
      ...
      $http
        .get(
          {
            url: `${hostEnv.protal_v3_11101}/public/send/mobile/captcha`,
            params: {
    ...
    msgLogin() {
      ...
      try {
        $http
          .get(
            {
              url: `${hostEnv.protal_v3_11101}/public/mobile/message/login`,
              params: {
                mobile: this.phoneNum.trim(),
                captcha: this.phoneCode.trim()
              }
            },
            false
          )
    ...
    accountLogin() {
      ...
      try {
        $http
          .get(
            {
              url: `${hostEnv.protal_v3_11101}/public/login`,
              params: {
...
.protal-login {
  ...
  .login-btn {
    box-shadow: 0 0 4px @u-type-primary;
