<template>
  <div class="knowing-statis page-layout u-fx">
    ...
    <add-Report-t ref="addWhite" :title="title" @updata="showList"></add-Report-t>
  </div>
</template>
