...
const home = {
  namespaced: true,
  state: {
    currentAppName: getState('currentAppName', ''), // 当前系统名
    ...
    menuUrl: getState('menuUrl', ''), // 当前菜单url
    appList: getState('appList', []), // 当前用户角色菜单列表
    menuList: getState('menuList', []), // 当前选中应用对应的菜单列表
