...
const projectName = 'protal-template' // 此处写项目名作为存储值，避免不同项目冲突
...
const home = {
  namespaced: true,
  state: {
    loginInfo: getState('loginInfo', JSON.parse(sessionStorage.getItem('loginInfo') || '{}')),
    loginType: getState('loginType', JSON.parse(sessionStorage.getItem('loginType') || '{}'))
  },
  actions: {
    ...actions
  },
