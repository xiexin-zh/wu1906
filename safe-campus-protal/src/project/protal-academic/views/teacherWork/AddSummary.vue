  ...
  <div class="add-plan">
    <a-form class="ant-advanced-search-form" :form="form">
        ...
        <a-col :span="10">
          ...
          >
            <a-select
              v-decorator="[
                'teachingType',
                { rules: [{ required: true, message: '请选择教学类别' }] }
              ]"
              placeholder="请选择"
            >
              <a-select-option value="1"> 期中 </a-select-option>
              <a-select-option value="2"> 期末 </a-select-option>
            </a-select>
          </a-form-item>
        </a-col>
      </a-row>
      ...
      <div class="content-box plan-text">
        <div class="box-title">教学质量总结内容：</div>
        <div class="box-main">
          <quill-editor
            style="height: 400px"
            v-model="content"
