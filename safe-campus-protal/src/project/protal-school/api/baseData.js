...
const baseData5Api = {
  ...
  // getParents: '/parent/children/list#get', // 获取学生家长列表 ---- 新版教务
  getParents: '/parent/children/queryParentChildCode#get', // 获取学生家长列表
  addParents: '/parent/children/add#post', // 添加家长
  deleteParent: '/parent/children/delete#get', // 删除家长
  editParent: '//parent/children/modify#post', // 修改家长
  ...
  // 学生获奖列表
  getAwardList: '/userinfo/student/user/award/list#get',

  // 学生处分列表
  getPunishment: '/userinfo/student/user/punishment/list#get',

  // 学生品德评语列表
  getMorality: '/userinfo/student/user/morality/list#get'
}

// 获取学生成绩
const scoreApi = {
  getScoreShow: '/test/score/getScoreListForPCByUserCode#post' // 查询学生的考试成绩
}
...
for (const val in scoreApi) {
  scoreApi[val] = `${hostEnv.protal_api_11013}${scoreApi[val]}`
}
