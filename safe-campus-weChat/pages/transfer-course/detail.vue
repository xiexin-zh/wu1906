<template>
  <view>
    <scroll-view scroll-y="true" class="scroll-h">
      ...
      <view
        v-for="(item, i) in detail.substituteInfoList"
        :key="i"
          ...
          <view>
            <view class="">
              ...
              <text class="u-padd-l40">
                {{ item.fromGradeName }}{{ isHighSchool ? item.fromProfessionName : '' }}{{ item.fromClassName }}第{{
                  item.fromLesson
            ...
            <view class="u-mar-t20" v-if="item.category === 2">
              ...
              <text class="u-padd-l40"
                >{{ item.toGradeName }}{{ isHighSchool ? item.toProfessionName : '' }}{{ item.toClassName }}第{{
                  item.toLesson
