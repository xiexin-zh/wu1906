	...
	<view class='home'>
		<view class="u-mar-20 ">
			<view class="input-box">
				...
				<u-input @blur="showList()" class="resourInput u-mar-t20 u-mar-b20 u-type-white-bg u-padd-l20" v-model="searchObj.resourceName"
				 placeholder='请输入资源名称' />
			</view>
			<dropdown-menu @value0Change="value0Change" :list0='resourceNames' :list1="firstData" :list2="secondData"
			 @value1Change='value1Change' @value2Change='value2Change'></dropdown-menu>
		</view>
		...
		<scroll-view scroll-y="true" v-else class="scroll-h " @scrolltolower="loadMore">
			<u-row gutter="16" class="">
				<u-col span="6" v-for="(item,index) in dataList" :key="index">
					<view @click="detail(item)" class="cont-box u-wh u-type-white-bg u-border-radius u-shadow ">
						<image class="image" border-radius='8' width="100%" height="192rpx" :src="item.thumbnailUrl "></image>
