<template>
	<view>
		...
		<view class="footer-btn u-fx-ac" v-if="tradeType === '2' && accountDetail.status === '1' && timestamp > 0">
			<u-button @click="confirm" type="primary" class="u-fx-f1 u-mar-l u-mar-r u-type-primary-dark-bg">
				<text class="u-mar-r20">继续支付</text>
				<u-count-down @end="countEnd" :show-hours="false" :timestamp="timestamp" font-size="32" separator-color="#fff" color="#fff" bg-color="#2b85e4"></u-count-down>
			</u-button>
		</view>
	</view>
</template>
...
export default {
	...
	methods: {
		...
		async confirm() {
			if (this.accountDetail.payType === 'WXPAY_JSAPI') {
				// 微信支付
