<template>
	<view class="u-page u-bg-fff">
		...
		<class-tree isCheck :isHighSchool="isHighSchool" v-show="classTag" :classTag="classTag" :schoolInfo="schoolInfo" @close="classTag = false" @confirm="classSelcet" :classChecked="classList"></class-tree>
		<teacher-tree
			isCheck
			v-show="teacherTag"
