    ...
    "devServer": {
      ...
      "proxy": {
        ...
        "/protal_api_11011": {
          ...
          // "target": "http://192.168.1.236:11011/", // 信息发布
          "changeOrigin": true,
          "pathRewrite": {
            "^/protal_api_11011": ""
          }
        ...
        "/protal_api_11014": {
          "target": "http://192.168.2.242:11014/", // 课表管理
          "changeOrigin": true,
          "pathRewrite": {
            "^/protal_api_11014": ""
          }
        ...
        "/protal_api_11002": {
          "target": "http://192.168.2.242:11002/", // 考试计划
          // "target": "http://192.168.1.236:11002/", // 考试计划
          "changeOrigin": true,
          "pathRewrite": {
            "^/protal_api_11002": ""
          }
        ...
        "/protal_api_11002": {
          ...
          // "target": "http://192.168.1.236:11002/",
          "changeOrigin": true,
          "pathRewrite": {
            "^/protal_api_11002": ""
          }
        ...
        "/protal_api_8091": {
          ...
          // "target": "http://192.168.1.236:8091/", // 安防系统
          "changeOrigin": true,
          "pathRewrite": {
            "^/protal_api_8091": ""
          }
        ...
        "/protal_api_8093": {
          "target": "http://192.168.2.242:8093/", // 教务系统
          // "target": "http://192.168.1.236:8093/", // 教务系统
          "changeOrigin": true,
          "pathRewrite": {
            "^/protal_api_8093": ""
          }
