...
if (system !== 'protal' && system !== 'protal-card' && system !== 'protal-safe' && system !== 'protal-door' && system !== 'protal-oa' && system !== 'protal-academic') {
...
if (system === 'protal') {
	...
	buildModule = '安防系统模块'
} else if (system === 'protal-door') {
	buildModule = '门禁考勤访客'
} else if (system === 'protal-oa') {
	buildModule = 'oa系统模块'
} else if (system === 'protal-academic') {
	buildModule = '教务系统模块'
}
const envHost = {
  prod: {
